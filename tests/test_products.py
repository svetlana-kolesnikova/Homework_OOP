...
def test_product_attributes(products) -> Any:
...
def test_product_init_price_0() -> Any:
...
def test_product_set_price_to_zero(new_product, new_price_0) -> Any:
...
def test_new_product(new_product_dict) -> Any:
...
def test_new_product_price_0(capsys, new_product_dict_price_0) -> Any:
...
def test_price_set_lower_with_user_confirmation_yes(monkeypatch, new_product) -> Any:
...
def test_price_set_lower_with_user_confirmation_no(monkeypatch, new_product) -> Any:
...
def test_product_str(new_product) -> Any:
...
def test_product_add(new_product, new_product1) -> Any:
    """Тест сложения сумм всех товаром двух продуктов"""
    result = new_product + new_product1
    assert result == 1260000.0


def test_product_add_oter_not_product_obj(new_product) -> Any:
